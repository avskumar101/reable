...
<input id="mobile" name="mobile" type="hidden" value="<?php echo $mobile1 ?>"/>
	...
	<table width="1140" border="0" align="center" cellpadding="0" cellspacing="0">
	 <tr>
		<td colspan="3"><img src="images/t.gif" width="40" height="20" /></td>
	  </tr>
	  <tr>

       <td width="700" valign="top" class="lrgspacing">
	...
	<table width="430" border="0" cellspacing="1" cellpadding="19" bgcolor="#E1E1E1">
	  <tr>
		<td width="400" align="center" bgcolor="#EAEAEA" class="size20">CONTACT CABRERA COASTAL REAL ESTATE</td>
	  </tr>
	  <tr>
		<td bgcolor="#EEF7FD">
...
<input name="phone" placeholder="Phone Number" type="text" class="gray padding" id="phone" style="width: 93%" onkeypress="return isNumber(event)" />
              ...
              <tr>
				...
				<select name="selectoptn" id="selectoptn" class="gray padding" style="width: 98%" >
...
<img src="images/submit.jpg" width="205" height="86" onclick="return validateForm();" alt="SUBMIT!" style="cursor: pointer;"/>				
     ...
     <tr>
        <td colspan="3"><img src="images/t.gif" width="40" height="25" /></td>
        </tr>
      <tr>
        <td colspan="3" bgcolor="#CCCCCC"><img src="images/t.gif" width="40" height="1" /></td>
        </tr>
      <tr>
        <td colspan="3"><img src="images/t.gif" width="40" height="25" /></td>
        </tr>
	...
	<tr>
	  ...
	  <table width="357" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <a href="property.php?MLSNo=<?php echo $datarcnt['MLSNo'];?>">
		  
		  <img src="<?php echo $image;?>" width="100" height="80" border="0" />
		  
		  </a></td><td width="20" align="left" valign="top">&nbsp;</td>
		  
		  <td width="237" align="left" valign="middle" class="medspacing">
		  
		  <span class="size13">  
		  
		  <a href="property.php?MLSNo=<?php echo $datarcnt['MLSNo'];?>">
		  
	<strong><?php echo $datarcnt['Address'].', '. $datarcnt['City'];?></strong></a><br />
		  
		  MLS: <?php echo $datarcnt['MLSNo'] ?> | Price: <strong class="green">$<?php echo number_format($datarcnt['Asking_Price']);?></strong><br />
		  
		 <?php echo $datarcnt['Days_On_Market'] ?> DOM | <?php echo $datarcnt['Bedrooms'] ?> Bd | <?php echo $datarcnt['Type'] ?></span><br /></td></tr></table>				  
	  </td>
	</tr>

	<tr><td><img src="images/t.gif" width="20" height="20" /></td></tr>
					
	<?php } ?>
			
       </table><p><a href="mls.php">SEARCH ALL PROPERTIES FOR SALE IN <?php echo $citynamecps;?>
	   
	   </a></p></td>
			  
		<td width="38" align="center" valign="top" background="images/horizontaldots.png">

		<img src="images/t.gif" width="38" height="38" /></td>
   ...
   <tr>
	  ...
	  <table width="357" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td width="100" align="left" valign="top"><a href="<?php echo $pgurl;?>">
		  
		  <img src="<?php echo $pgrepimg;?>" width="100" height="80" border="0" /></a></td>
		  		  
		  <td width="20" align="left" valign="top">
		  
		  <img src="images/t.gif" width="20" height="20" /></td>
		  
		  <td width="237" align="left" valign="middle" class="medspacing">
		  
		  <span class="size13"><?php 
		  
		  $headline=explode(',', $avl['propertyheadline']);
		  
		  echo $headline[0];?><br />
		  
		<?php echo $avl['street'].', '.$avl['city'];?><br />
			
		<?php echo $avl['bedroom'];?> Bd | <?php echo $avl['bathroom'];?> Ba | Sleeps <?php echo $avl['sleepupto'];?> | <a href="<?php echo $pgurl;?>">View Details</a></span><br /></td>
	...
	<?php } ?>	
	  ...
	  <p><a href="vacationrentals.php">SEARCH FOR <?php echo $citynamecps;?> RENTALS</a></p></td>
	...
	if($data['mainimg']!=''){ $image=$data['mainimg'];} else { $image="images/nopicture.png"; }
	...
	<tr>
	  ...
	  <img src="<?php echo $image;?>" width="100" height="80" border="0" /></td>
	  ...
	  <span class="size13"><?php echo $data['Address'] ?>, <?php echo $data['City'] ?><br />
	  
		Sold: </span><span class="red">
		
		<strong>$<?php echo number_format( $data['soldprice']);?></strong></span>
		
	<span class="size13"> | <?php echo date('m/d/y',strtotime($data['closingdate'])); ?><br />
		
	<?php echo $data['Days_On_Market'] ?> DOM | <?php echo $data['Type'] ?>
	...
	<?php } ?>
       ...
       <p><a href="<?php echo $citynamelwa.'sold.php'?>">MORE RECENTLY SOLD PROPERTIES IN <?php echo $citynamecps;?></a></p>
