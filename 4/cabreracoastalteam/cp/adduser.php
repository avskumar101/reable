...
if($_POST['useraccount']=="Save User Information")		
	{
	if($_POST['captcha']!='')
		{
			...
			$usertype = $_POST['drop_usertype'];
	
			
            mysql_query("insert into tbl_user(name,email,password,del_status) values ('".$name."','".$email."','".$password."','0')");
		    header("Location: index.php");
			}
			else
			{
        ...
        <td><h2>USER ACCOUNTS</h2>
          <table width="1122" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="19"><img src="../images/t.gif" width="19" height="10" /></td>
              <td width="220"><strong>Password: </strong>(<a href="#" onclick="alert(document.getElementById('txt_password').value);">View</a>)</td></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              <td><input name="txt_fullname" type="text" id="txt_fullname" style="width: 98%" /></td>
              <td>&nbsp;</td>
              <td><input name="txt_email" type="text" id="txt_email" style="width: 98%" /></td>
              <td>&nbsp;</td>
              <td><input name="txt_password" type="password" id="txt_password" style="width: 98%" /></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td colspan="6">&nbsp;</td>
             ...
             <table width="270" border="0" cellspacing="2" cellpadding="1">
                ...
                <tr>
                  <td> <input name="useraccount" id="useraccount" type="submit" value="Save User Information" />
