		...
		foreach ($classes as $classval) 
		{
			...
			while ($listing = $rets->FetchRow($search)) 
			{
				...
				if (mysql_num_rows(mysql_query("select * from tbl_listings where MLSNo='".$MLSNo."'"))>0)
				{
					...
					saleorsold='".mysql_real_escape_string($saleorsold)."',
				...
				else
				{
					...
					'".mysql_real_escape_string($saleorsold)."',
				...
				$photoqry=" update tbl_listings set ";
