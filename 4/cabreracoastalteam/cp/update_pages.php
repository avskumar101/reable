...
if (mysql_num_rows(mysql_query("select * from tbl_homepage where id='".$_GET['id']."'"))<=0)
	...
	$opt_row=mysql_fetch_array(mysql_query("select * from  tbl_homepage where id='".$_GET['id']."'"));
...
<tr>
  ...
  <tr>
	...
	<h2>UPDATE PAGES &gt; <?php echo $opt_row['page_name']; ?> </h2>
          ...
          <table width="1122" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td>
			  	...
			  	<?php
				if($_POST['page_name']=="") {
				$txt_email=$opt_row['page_name']; }					
				else { 
				$txt_email=$_POST['page_name']; }
				?>		
			  
			  <input name="page_name" type="text" id="page_name" style="width: 85%" value="<?php echo $txt_email;?>" /></td>
            ...
            <tr>
              ...
              <td>
			  	...
			  	<?php
				if($_POST['meta_title']=="") {
				$txt_email=$opt_row['meta_title']; }					
				else { 
				$txt_email=$_POST['meta_title']; }
				?>		
		
			  
			  
			  <input name="meta_title" type="text" id="meta_title" style="width: 85%" value="<?php echo $txt_email;?>" /></td>

              <td>
			  			  			  
			  	<?php
				if($_POST['meta_key']=="") {
				$txt_email=$opt_row['meta_key']; }					
				else { 
				$txt_email=$_POST['meta_key']; }
				?>		
		
			  
			  <input name="meta_key" type="text" id="meta_key" style="width: 85%" 

			  value="<?php echo $txt_email;?>" /></td>
              ...
              <td>
				...
				$txt_email=$opt_row['meta_desc']; }					
				else { 
				$txt_email=$_POST['description']; }
				?>		
		
			
			  
			  <input name="description" type="text" id="description" style="width: 85%" value="<?php echo $txt_email;?>" /></td>
            ...
            <tr>
              ...
              <td colspan="4">
			  	...
			  	<?php
				if($_POST['content']=="") {
				$txt_email=$opt_row['content']; }					
				else { 
				$txt_email=$_POST['content']; }
				?>		
		
			
			  
			  <textarea name="content" rows="15" id="content" style="width: 98%"> <?php echo $txt_email;?></textarea></td>
