	...
	if($_POST['btn_person']=="Update")		
	{
		...
		{ 
			if(captcha_validate())
			{
					...
					$descriptions=str_replace("<p>","",$_POST['description']); 
      ...
      <tr>
        <td><h2>UPDATE PAGES &gt; MEET OUR TEAM &gt; ADD / MODIFY</h2>
		  ...
		  ?>
            ...
            <tr>
              <td colspan="5"><input type="file" name="fileField" id="fileField"  /><?php echo $resultarrays['image_filename']; ?></td>
            </tr>
            <tr>
              <td colspan="5">&nbsp;</td>
            </tr>
            ...
            <tr>
			 ...
			 <?
					...
					?>
            <tr>
               <td colspan="5"><textarea name="description" rows="15" id="description" style="width: 98%"><?php echo $txt_description_value;?></textarea></td>
            </tr>
            <tr>
              <td colspan="5">&nbsp;</td>
            </tr>
