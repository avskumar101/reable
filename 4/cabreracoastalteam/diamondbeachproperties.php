...
$result_query=mysql_fetch_array(mysql_query("select * from tbl_homepage where id='10'"));
...
<link rel="alternate" href="http://cabreracoastalteam.com/mobile/diamondbeachproperties.php"/>
