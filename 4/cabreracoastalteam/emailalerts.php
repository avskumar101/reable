    ...
    <td class="pagebg"><table width="1120" border="0" align="center" cellpadding="0" cellspacing="15">
      ...
      <tr>
        ...
        <td width="655" height="300px"align="left" valign="top" style="margin-top:20px;">
		  ...
		  <p><!--Begin CTCT Sign-Up Form-->
<!-- EFD 1.0.0 [Wed Jul 01 17:30:45 EDT 2015] -->
<link rel='stylesheet' type='text/css' href='https://static.ctctcdn.com/h/contacts-embedded-signup-assets/1.0.2/css/signup-form.css'>
<div class="ctct-embed-signup" style="font: 16px Helvetica Neue, Arial, sans-serif; font: 1rem Helvetica Neue, Arial, sans-serif; line-height: 1.5; -webkit-font-smoothing: antialiased;">
   <div style="color:#0033CC; background-color:#FFFFFF; border-radius:5px;">
       <span id="success_message" style="display:none;">
           <div style="text-align:center;">Thanks for signing up!</div>
       </span>
       <form data-id="embedded_signup:form" class="ctct-custom-form Form" name="embedded_signup" method="POST" action="https://visitor2.constantcontact.com/api/signup">
           <h2 style="margin:0;">Join Our Mailing List to Stay Informed!</h2>
           <p>Thank you for joining the Cabrera Coastal Real Estate mailing list. We look forward to keeping you up-to-date with the latest real estate updates, community news, upcoming events and more.</p>
           <!-- The following code must be included to ensure your sign-up form works properly. -->
           <input data-id="ca:input" type="hidden" name="ca" value="069c6baa-8b49-4f1e-96e3-732cdbdd57be">
           <input data-id="list:input" type="hidden" name="list" value="1841273261">
