...
<tr>
  ...
  <tr>
    <td><table width="1147" border="0" align="center" cellpadding="0" cellspacing="13">
      <tr>
        <td><h1><pre>2014 EVENTS IN CAPE MAY, WILDWOOD &amp; THE SURROUNDING AREAS</pre></h1>
		  <?php
						for ($k=0;$k<=11;$k++)
						{
							$month=$months[$k];
							$mon=$k+1;
							$eventres=mysql_query("SELECT * FROM tbl_events where MONTH(FROM_UNIXTIME(eventdate ))=".$mon." and YEAR(FROM_UNIXTIME(eventdate))=YEAR(NOW()) and deletestatus != 1 and city='Cape May'   order by eventdate limit 7;");
							$i=0;
		...
		<tr>		
        <td width="975"><span class="spacing"><span class="style8"><strong><?php echo $eventrow['eventname'];?></strong></span><br />

		<?php echo $eventdatevalue;?> - <?php echo $eventrow['city'];?><br />
		<?php echo $eventrow['event_desc'];?></span></td>
						  </tr>
						</table>
						<br />
