<?php
...

		{
			...
			{				
...

				{
					...
					bankowned='".mysql_real_escape_string($bankown)."',
...

				{
					...
					'".mysql_real_escape_string($Tax_Year)."',1,'".mysql_real_escape_string($L_ListOffice)."','".mysql_real_escape_string($listuserfirstname)."','".mysql_real_escape_string($listuserlastname)."','".mysql_real_escape_string($bankown)."')";
	...
	$rowres=mysql_query("select MLSNo from tbl_listings where active='1' and mainimg is null");
