			...
			<input type="hidden" id="search_properties" name="search_properties" value="search_mlshome" />
			 ...
			 <div id="forsalediv" name="forsalediv" style="margin-top:0px;display:none;">
              ...
              <tr>
                ...
                <td width="12" rowspan="2" background="images/fadedblue.png"><img src="images/t.gif" width="12" height="96" style="width:10px;" /></td>
              </tr>
              <tr>
                <td valign="bottom" background="images/fadedblue.png"><table width="585" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="536" background="images/searchbox.png"><input type="text" id="searchactivehometext" name="searchactivehometext" placeholder="ENTER A CITY, ADDRESS OR MLS NUMBER TO SEARCH" class="searchBox" style="color:#AAAAAA;width:525px;"></td>
                    <td width="49">
			 ...
			 <div id="recentsolddiv" name="recentsolddiv" style="margin-top:0px;display:none;">
              ...
              <tr>
                <td valign="bottom" background="images/fadedblue.png"><table width="585" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="536" background="images/searchbox.png"><input type="text" id="searchsoldhometext" name="searchsoldhometext" class="searchBox" placeholder="ENTER A CITY, ADDRESS OR MLS NUMBER TO SEARCH" class="searchBox" style="color:#AAAAAA;width:525px;"></td>
                    <td width="49">
