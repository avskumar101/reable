...
//$sql = "select mlsno,Address,City,State,Zip from tbl_listings where city = 'Cape May Court House' and active=1 and delete_status = 0 order by Asking_price desc";
...
$prepAddr = rawurlencode($address);
	        $geocode=file_get_contents('https://maps.google.com/maps/api/geocode/json?key=AIzaSyBxAfRIfyrssYdS84ycaY932NwMlfBb_ZU&address='.$prepAddr.'&sensor=false');
