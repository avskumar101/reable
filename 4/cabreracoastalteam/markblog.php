...
function format_cash($cash) {
	...
	if($len >= 2)
	{
		//$text = '$'.number_format($text) . 'K';
		$text = '$'.format_cash($text);
		
		$image_file 	= 'bg_marker_new.png';
	...
	else 
	{
		...
		$image_file 	= 'bg_marker_small.png'; 		// x and y for the bottom right of the text
