...
if($_SESSION['searchtype'] == "search_mlsaddress"){
	...
	$val = $_SESSION['HOMESEARCHTEXT'];	
	$activesold = $_SESSION['HOMESEARCHACTIVESOLDTEXT'];
	$cond .= " and status='$activesold'";
	if ($val!='0' && $val!="")
	{
		$mlsnosearch = $val;
		$cond .= " and (MLSno='$mlsnosearch' OR city = '$mlsnosearch' OR Address like '%$mlsnosearch%')";
	}
}
