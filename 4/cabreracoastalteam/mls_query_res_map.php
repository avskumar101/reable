...
if($orgname != ""){
	...
	if($agentfirstname != "" && $agentlastname != ""){
				...
				//$cond = "Org_Name = 'Long & Foster Real Estate Inc - Wc'";
				$co = 0;
		...
		//$cond .= "and (agent_firstname = 'Jeanine' and agent_lastname = 'Cabrera') OR (agent_firstname = 'Joan' and agent_lastname = 'Morey') ";
	}
}
...
//$sql .= $cond." order by Asking_Price asc limit $start, $pagesize  ";
$sql = $columns.$sql;
