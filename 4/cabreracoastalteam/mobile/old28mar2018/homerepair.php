...
<?php
  ...
  $result_query=mysql_fetch_array(mysql_query("select * from tbl_homepage where id=16"));
...
<link rel="canonical" href="http://cabreracoastalteam.com/homerepair.php" />
  ...
  <tr>
    ...
    <td width="100%"><table width="1080" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="232"><a href="../homerepair.php?Mobile=Off"><img src="images/fullsite.png" width="232" height="248" border="0"/></a></td>
