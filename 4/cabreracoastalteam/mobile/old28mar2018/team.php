...
<link rel="canonical" href="http://cabreracoastalteam.com/team.php" />

<title>Cabrera Coastal Team - Mobile Meet The Team</title>
...
<table width="1080" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100%"><table width="1080" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="232"><a href="../team.php?Mobile=Off"><img src="images/fullsite.png" width="232" height="248" border="0"/></a></td>
  ...
  <tr>
    <td><table width="1080" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="245"><img src="<?php echo $filename;?>" width="245" height="300" /></td>
        <td width="40"><img src="images/t.gif" width="40" height="30" /></td>
        <td width="795" align="left" valign="middle" class="lrgspacing"><strong class="largefont2"><?php echo $resultarray['name']?></strong><br />
          <?php echo $resultarray['title'];?><br />
          <a href="mailto:<?php echo $resultarray['email'];?>"><?php echo $resultarray['email'];?></a><br />
		  <?php
		  if($resultarray['phone']!=''){
		  ?>
          <?php echo $resultarray['phone'];?><strong></strong></td>
		  <?php
		 }
		  ?>
      </tr>
