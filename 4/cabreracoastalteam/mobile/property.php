...
<table width="1080" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  $resultimage=mysql_query("SELECT * FROM  tbl_listings where MLSNo='$ID' ");
	...
	$imageval = $imagearray['mainimg'];
		...
		$imagegt=$imagearray["mainimg"];

		$urlph=substr($imagegt, 0, 2);

		if($urlph=='//') {

			$imagegetdb="http://".substr($imagegt,2);
	...
	list($imgwidth, $imgheight, $type, $attr) = getimagesize($imagegetdb);
  ...
  <tr>
    ...
    <td><img src="<?php echo $imagegetdb;?>" width="1080" height="<?php echo $height; ?>" /></td>
  ...
  <tr>
	...
	<?php echo $resultarray['City']; ?></span></strong></td>
  ...
  <tr>
    ...
    <td align="center" class="largefont2"><a href="<?php echo $resultarray['cust_url'];?>" target="_blank" >	<img src="../images/virtual_tour.png" alt="virtualtour" width="350" height="auto" />				
				   </span>   </td>

  </tr>
<?php } else if($resultarray['tour_url']!=""){ ?>
 <tr>
  ...
  <tr>
    ...
    <td align="center" class="largefont2"><a href="<?php echo $resultarray['tour_url'];?>" target="_blank" >	<img src="../images/virtual_tour.png" alt="virtualtour" width="350" height="auto" />				
				   </span>   </td>
...
<?php } ?>
  ...
  <tr>
	...
	<img src="<?php echo $imagegetdb;?>" width="1080" height="<?php echo $height; ?>" /></td>
