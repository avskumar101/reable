...
if($_POST['mobile']=='') {
	...
	if($urlname=='Mobile=Off' || $Mobile=='Off') {
	 ...
	 echo "<script>window.location='rentaladdress.php?Mobile=Off".$_SERVER['QUERY_STRING']."';</script>";
...
if($_POST['btnsubmit']=='listsubmit') {	
	...
	$mysql=" and street like '%".$searchbyaddress."%'";
	...
	header("Location:rentalresults.php?uadd=".$_POST['address']."");
 ...
 <tr>
	...
	<table width="1170" border="0" align="center" cellpadding="0" cellspacing="0" class="lrgspacing">
      ...
      <tr>
        ...
        <td align="center"><h1>SEARCH BY RENTAL ADDRESS</h1>
          ...
          <table width="1064" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
			  ...
			  <table width="750" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="230" align="center" valign="middle" bgcolor="#195CAB" class="size15"><a href="vacationrentals.php" class="whitelink">WEEKLY RENTAL SEARCH</a></td>

                  <td width="25"><img src="images/t.gif" width="25" height="50" /></td>

                  <td width="195" align="center" bgcolor="#1E8BCC"><strong class="white size15">SEARCH BY ADDRESS</strong></td>
                    ...
                    <tr>
                      ...
                      <td width="1022"><table width="1022" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td><span class="red">*</span><u>SEARCH BY ADDRESS</u></td>
			...
			<input name="address" type="text" id="address" style="width:30%;padding:10px;" value="<?php echo $_GET['uadd'];?>"/>
