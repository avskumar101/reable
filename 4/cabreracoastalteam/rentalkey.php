...
if($_POST['mobile']=='') {
	...
	if($urlname=='Mobile=Off' || $Mobile=='Off') {
	 ...
	 echo "<script>window.location='rentalkey.php?Mobile=Off".$_SERVER['QUERY_STRING']."';</script>";
...
if($_POST['btnsubmit']=='listsubmit') {	
	...
	$searchbyaddress=$_POST['address'];
 
	$mysql=" and cid like '%".$searchbyaddress."%'";
 
	$stmt5 = mysql_query("SELECT * FROM search_results where HideList='0' $mysql  group by cid");
				
	$i=0;	
	while($avl = mysql_fetch_array($stmt5))
	{
		
		$desc=$avl['propertydesc'];
		...
		//$propertyheadline=$avl['propertyheadline'];			
	...
	$stmt= mysql_query("insert into search_results_data(cid, referenceid, city, propertyheadline, bedroom, bathroom, halfbath, sleepupto, location, rate, propertydesc, imgPreview,propertytype)values('$cid','$referenceid','$cityname','$propertyheadline','$bedroom','$bathroom','$halfbath','$sleepupto','$location','$rate','$disc','$pgrepimg','$propertytype')");
	
	
	}
	
	header("Location:rentalresults.php?key=".$_POST['address']."");
...
<meta http-equiv="keywords" content="Cabrera Coastal Team" />

<meta http-equiv="description" content="Cabrera Coastal Team" />
...
function submitform() {
	...
	var x = document.forms["rentalsearch1"]["address"].value;
    if (x == null || x == "") {
        alert("Please Enter Your Rental Key and Try Again.");
        rentalsearch1.address.focus();
		return false;
    }	
 ...
 <tr>
	...
	<table width="1170" border="0" align="center" cellpadding="0" cellspacing="0" class="lrgspacing">
      ...
      <tr>
        ...
        <td align="center"><h1>SEARCH BY RENTAL KEY</h1>
          ...
          <table width="1064" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
			  ...
			  <table width="750" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="230" align="center" valign="middle" bgcolor="#195CAB" class="size15">
				  <a href="vacationrentals.php" class="whitelink">WEEKLY RENTAL SEARCH</a></td>
                  ...
                  <td width="215" align="center" bgcolor="#1E8BCC">
				  <strong class="white size15">SEARCH BY RENTAL KEY</strong></td>
            ...
            <tr>
              ...
              <td><table width="1064" border="0" cellspacing="3" cellpadding="18" bgcolor="#1E8BCC">
                ...
                <tr>
                  ...
                  <td bgcolor="#F8F5ED"><table width="1022" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td width="1022"><table width="1022" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td><span class="red">*</span><u>SEARCH BY RENTAL KEY</u></td>

                        </tr>

                        <tr>

                          <td><img src="images/t.gif" width="16" height="10" /></td>
			...
			<input name="address" type="text" id="address" style="width:30%;padding:10px;" value="<?php echo $_GET['key'];?>"/>
                        ...
                        <tr>
                          ...
                          <td><img src="images/t.gif" width="16" height="25" /></td>
...
<img src="images/rentalsearch.jpg" width="465" height="80" alt="Search Vacation Rentals" border="0" onclick="return submitform();" style="cursor:pointer;"/>			  
